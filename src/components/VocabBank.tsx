    ...
    >
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <span className="font-cjk-serif text-xl text-[#FFF8E7] leading-none">福</span>
          <div className="flex flex-col leading-tight min-w-0">
            <span className="text-[11px] uppercase tracking-[0.2em] text-[#D4AF37]">Vocab Bank</span>
            <span className="text-[10px] text-[#E8C9A0]/80 truncate">生词本</span>
          </div>
        </div>
        <button
          type="button"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto thin-scroll">
        ...
        {loading && (
          <div className="h-full flex flex-col items-center justify-center gap-2 text-[#E8C9A0]/85">
            ...
            <span className="text-[11px]">Picking key vocabulary…</span>
          </div>
        )}
